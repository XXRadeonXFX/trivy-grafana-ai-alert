...
> **Note:** Replace the below placeholders with actual screenshots of these emails:
> - ![Success Email](images/success_email.png)
> - ![Failure Email](images/failure_email.png)
> - ![Daily Alert](images/daily_alert.png)
> - ![Weekly Alert](images/weekly_alert.png)
> - ![AI Recommendation](images/ai_recommendation_email.png)
...
- **Log in to Grafana**:  
  ...
  ![Login to Grafana](images/grafana-login.png)

- **Navigate to Data Sources**:  
  - Click on the **Gear (⚙️) icon** in the left sidebar.  
  - Select **Data Sources** → **Add data source**.  
  ![Data Sources Navigation](images/grafana-data-sources.png)

- **Select PostgreSQL**:  
  - Search for **PostgreSQL** in the list of available data sources.  
  - Click **Select**.  
  ![Select PostgreSQL](images/grafana-select-postgresql.png)
...
- **Configure Connection Details**:  
  ...
  ![Configure PostgreSQL Connection](images/grafana-configure-postgresql.png)
...
- **Set Time Zone and Options**:
  ...
  ![PostgreSQL Options](images/grafana-postgresql-options.png)

- **Save & Test**:
  - Click **Save & Test**.
  - Ensure Grafana confirms a successful connection.  
  ![Save and Test](images/grafana-save-test.png)
...
- **Go to Dashboard Import in Grafana**:
  ...
  - Select **Import**.  
  ![Import Dashboard Navigation](images/grafana-import-dashboard.png)
...
- **Upload or Paste Dashboard JSON**:
  ...
  ![Upload Dashboard JSON](images/grafana-upload-trivy-dashboard.png)

- **Select Data Source**:
  - When prompted, choose the PostgreSQL data source configured in **Step 1**.  
  ![Select Data Source](images/grafana-select-datasource.png)

- **Click Import**:
  - The `Trivy Project Security Dashboard` will now appear in your Grafana dashboard list.  
  ![Dashboard Imported](images/grafana-dashboard-imported.png)
...
- **Verify Dashboard**:
  - Open the dashboard to ensure data is populating correctly:
    ...
    - **Historical Trends**  
  ![Verify Dashboard Data](images/grafana-verify-trivy-dashboard.png)
...
- **Navigate to Import Dashboard in Grafana**:
  ...
  - Select **Import**.  
  ![Import Build Dashboard Navigation](images/grafana-import-build-dashboard.png)

- **Upload or Paste Dashboard JSON**:
  - Use the `grafana-dashboard/Build-Dashboard.json` file from the repository.
  - Either **Upload JSON file** or **Paste JSON** content into the import screen.  
  ![Upload Build Dashboard JSON](images/grafana-upload-build-dashboard.png)

- **Link to PostgreSQL Data Source**:
  - When prompted, select the same PostgreSQL data source configured in **Step 1**.  
  ![Select Build Dashboard Data Source](images/grafana-build-dashboard-select-datasource.png)

- **Click Import**:
  - The `Build Dashboard` will now be available in your Grafana dashboard list.  
  ![Build Dashboard Imported](images/grafana-build-dashboard-imported.png)
...
- **Verify Child Dashboard Linking**:
  ...
  ![Verify Build Dashboard Linking](images/grafana-verify-build-dashboard.png)
